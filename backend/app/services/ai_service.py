...
Exact same logic as original Backend/app/services/ai_service.py
"""
...
class AIService:
        ...
        try:
            kwargs = {
                ...
                "messages": [
                    {
                        "role": "system",
                        "content": "You are a helpful HR assistant designed to analyze resumes. "
                                   + ("You MUST output valid JSON." if json_mode else ""),
                    },
    ...
    def anonymize(self, text: str) -> str:
        """Anonymize resume text for bias-free analysis."""
        prompt = f"""
    ...
    def extract_location(self, text: str) -> str:
        """Extract target job location from JD text."""
        prompt = f"""
