"""
JD Service - Job Description Generation
Exact same AI prompt and logic as original JD_Generator/backend/agent.py
"""
...
async def generate_jd(data: dict) -> str:
    """
    AI Agent to generate a professional, ATS-friendly JD based on structured inputs.
    Exact same prompt as original JD_Generator/backend/agent.py
    """
    prompt = f"""
    ...
    - MIMITIC KEYWORD DENSITY: Ensure the 'Required Skills' and 'Tech Stack' sections are keyword-rich.
...
def generate_jd_id() -> str:
    """Generate a unique JD identifier."""
